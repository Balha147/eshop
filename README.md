...
Cart Signal
  ...
  @include respond-to('desktop') {
    &::before {
      ...
      background-image:
        url(./assets/images/accounts-shape-square.svg),
        url(./assets/images/accounts-shape-circle.svg),
        url(./assets/images/accounts-shape-blue.svg);
    }
    ...
    &::after {
      ...
      background-image:
        url(./assets/images/accounts-shape-fold-1.svg),
        url(./assets/images/accounts-shape-fold-2.svg);
    }
  }
}
